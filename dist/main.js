(function () {
    ...
    const tags = [
        ...
        {
            name: "Skeleton",
            description: "For having a rocket with only 10% of its mass consisting of structure parts",
            rarity: "Epic",
            combos: ["UNKNOWN"],
        },
        {
        ...
        {
            name: "Thin",
            description: "For having the rocket width at least 5 times smaller than its height",
            rarity: "Uncommon",
            combos: ["UNKNOWN"],
        },
        {
        ...
        {
            name: "Trident",
            description: "For using 3 upward straight parts at roughly the same height that are not attached to each other",
            rarity: "Rare",
            combos: ["COOL"],
        },
        {
        ...
        {
            name: "Flat",
            description: "For having a rocket width at least 5 times bigger than its height",
            rarity: "Rare",
            combos: ["UNKNOWN"],
        },
        {
            name: "Cross",
            description: "For combining 2 rectangle shaped part to create a cross shape",
            rarity: "Rare",
            combos: ["SMART"],
        },
        {
        ...
        {
            name: "Minotaur",
            description: "For using a mannequin torso, arms and legs and a Dandy Deer head",
            rarity: "Rare",
            combos: ["UNKNOWN"],
        },
        {
        ...
        {
            name: "Spaghetti",
            description: "For having at least 3 pipes with a length of at least 2 meters",
            rarity: "Rare",
            combos: ["UNKNOWN"],
        },
        {
        ...
        {
            name: "Robot",
            description: "For reaching a distance of 5 meters without propulsion or explosives",
            rarity: "Epic",
            combos: ["SMART"],
        },
        {
    ...
    <div class="tag-tooltip">
      ...
      ${tag.combos
        .map((combo) => `<span class="${combo}">${combo.replace("UNKNOWN", "???")}</span>`)
        .join(", ")}
    </div>
  `;
